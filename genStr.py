...
API_TEXT = """Hi, {}.
This is Pyrogram's String Session Generator Bot Developed By @Dr_Asad_Ali , I will generate String Session of your Telegram Account.

By @Dr_Asad_Ali Join Here For Update @Shayri_Music_Lovers

Now send your `API_ID` same as `APP_ID` to Start Generating Session."""
HASH_TEXT = "Now send your `API_HASH`.\n\nPress /cancel to Cancel Task."
PHONE_NUMBER_TEXT = (
    "Now send your Telegram account's Phone number in International Format. \n"
    "Including Country code. Example: **+923123456789**\n\n"
    "Press /cancel to Cancel Task."
)
...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@Dr_Asad_Ali](tg://openmessage?user_id=1472531255) \nA Bot By @AsadSupport")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/Shayri_Music_Lovers'),
                InlineKeyboardButton('Developer', url='https://t.me/Dr_Asad_Ali')
            ],
            [
                InlineKeyboardButton('Updates Channel', url='https://t.me/jankarikiduniya'),
            ]
        ]
    )
